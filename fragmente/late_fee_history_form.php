                ...
                <?php if (!empty($result)): ?>
                    <?php foreach ($result as $res): ?>
                        <tr>
                            ...
                            <td><?= number_format($res['late_fee'], 2) ?></td>
                            <td><?= (htmlspecialchars($res['payment_status']) === 'not paid') ? "Neplatita" : "Platita" ?></td>
                            <td><?= htmlspecialchars($res['updated_at']) ?? "-" ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
                        <td colspan="7">
                            <p class="text-center">Nu s-au gasit inregistrari pentru filtrul selectat.</p>
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
