...
<head>
    <?php
    view('head', ['title' => 'Istoric penalizari']);
    ?>
...
<div class="wrapper">
    ...
    <div class="wrapper-user-account">
        <div class="title">
            <h2>Istoricul taxelor de intarziere</h2>
        </div>
        <!-- bara cautare detalii imprumuturi-->
        <div class="search-bar search-bar-user container">
            <form action="" method="get" class="mb-3">
                <div class="form-group">
                    <input type="text" class="form-control search-box search-box-user" name="search" placeholder="Cauta detalii taxe...">
                </div>
        ...
        ?>
        <?php include __DIR__ . "/../admin/fee_history.php"; ?>
    </div>
</div>
</main>
</body>
