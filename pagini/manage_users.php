...
<head>
    <?php
    view('head', ['title' => 'Utilizatorii MBA'])
    ?>
...
<div class="wrapper">
    ...
    <div class="wrapper-user-account">
        ...
        <!-- bara cautare utilizatori-->
        <div class="search-bar search-bar-user container">
            <form action="" method="get" class="mb-3">
                <div class="form-group">
                    <input type="text" class="form-control search-box search-box-user" name="search" placeholder="Cauta detalii utilizator...">
                </div>
        ...
        ?>
        <?php include __DIR__ . "/../admin/pagination_users.php"; ?>
    </div>
</div>
</main>
</body>
